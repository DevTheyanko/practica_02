                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        <?php if(isset($_SESSION['usuario'])): ?>
                            <a class="dropdown-item" href="">
                                <i class="bi bi-question-circle"></i> Info
                            </a>
        ...
        <div class="menu-block customscroll">
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    ...
                    <li>
                        <a href="index.php?c=cargo&a=index" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-person-bounding-box"></span>
                            <span class="mtext">Cargos</span>                           
                        </a>
                    </li>  
                    <li>
                    ...
                    <li>
                     ...
                     <li>
                        <a href="index.php?c=casillero&a=index" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-save2"></span>
                            <span class="mtext">Casilleros</span> 
                    ...
                    <li>
                     ...
                     <li>
                        <a href="index.php?c=categoria&a=index" class="dropdown-toggle no-arrow">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="submenu">
                            <li><a href="index.php?c=prealerta&a=index">Entrada-(Prealerta)</a></li>
                    ...
                    <li>
                     ...
                     <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            ...
                            <span class="mtext">Sacas</span> 
                        </a>
                        <ul class="submenu">
                            <li><a href="index.php?c=entrada&a=index">Registro</a></li>
                    ...
                    <li>
                        <a href="#" class="dropdown-toggle no-arrow">
                            ...
                            <span class="mtext">Manifiesto</span>  
                        </a>
                    </li>
                    <li>
                        <a href="#" class="dropdown-toggle no-arrow">
